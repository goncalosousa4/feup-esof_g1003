...
import 'login_reg_page_seller_model.dart';
export 'login_reg_page_seller_model.dart';

class LoginRegPageSellerWidget extends StatefulWidget {
  const LoginRegPageSellerWidget({super.key});

  @override
  State<LoginRegPageSellerWidget> createState() =>
      _LoginRegPageSellerWidgetState();
}

class _LoginRegPageSellerWidgetState extends State<LoginRegPageSellerWidget> {
  late LoginRegPageSellerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginRegPageSellerModel());
  }
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              ...
              Align(
                alignment: const AlignmentDirectional(0.29, -0.36),
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(8.0),
                  child: Image.asset(

...
import 'login_page_seller_model.dart';
export 'login_page_seller_model.dart';

class LoginPageSellerWidget extends StatefulWidget {
  const LoginPageSellerWidget({super.key});

  @override
  State<LoginPageSellerWidget> createState() => _LoginPageSellerWidgetState();
}

class _LoginPageSellerWidgetState extends State<LoginPageSellerWidget>
    with TickerProviderStateMixin {
  late LoginPageSellerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginPageSellerModel());
              ...
              Align(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    context.pushNamedAuth('salesInfo', context.mounted);
                  },
                  text: 'Login',
              ...
              Opacity(
                ...
                child: Align(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      context.pushNamed('regPageSeller');
                    },
                    child: Text(
                      'Register now',
                      textAlign: TextAlign.start,

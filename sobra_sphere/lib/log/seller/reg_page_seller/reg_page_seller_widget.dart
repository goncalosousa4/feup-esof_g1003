...
import 'reg_page_seller_model.dart';
export 'reg_page_seller_model.dart';

class RegPageSellerWidget extends StatefulWidget {
  const RegPageSellerWidget({super.key});

  @override
  State<RegPageSellerWidget> createState() => _RegPageSellerWidgetState();
}

class _RegPageSellerWidgetState extends State<RegPageSellerWidget>
    with TickerProviderStateMixin {
  late RegPageSellerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegPageSellerModel());

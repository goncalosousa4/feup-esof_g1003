...
import 'inesctec_model.dart';
export 'inesctec_model.dart';

class InesctecWidget extends StatefulWidget {
  const InesctecWidget({super.key});

  @override
  State<InesctecWidget> createState() => _InesctecWidgetState();
}

class _InesctecWidgetState extends State<InesctecWidget> {
  late InesctecModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InesctecModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<SalesInfoWeekRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SalesInfoWeekRecord> inesctecSalesInfoWeekRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final inesctecSalesInfoWeekRecord =
            inesctecSalesInfoWeekRecordList.isNotEmpty
                ? inesctecSalesInfoWeekRecordList.first
                : null;
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              return FFButtonWidget(
                                                onPressed: () async {
                                                      ...
                                                      .set(
                                                        ...
                                                        restaurantName:
                                                            buttonAvailableBagsRecord
                                                                .name,
                                                        image:
                                                            'https://www.pingodoce.pt/wp-content/uploads/2021/08/cozido-portuguesa-transmontano.jpeg',
                                                        user:
                                                  ...
                                                  await inesctecSalesInfoWeekRecord!
                                                      .reference
                                                      .delete();
                                                },
                                                text: 'Buy bag',

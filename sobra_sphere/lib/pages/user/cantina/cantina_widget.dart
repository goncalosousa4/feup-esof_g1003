...
import 'cantina_model.dart';
export 'cantina_model.dart';

class CantinaWidget extends StatefulWidget {
  const CantinaWidget({
    super.key,
    int? bags,
  }) : bags = bags ?? 0;
  ...
  @override
  State<CantinaWidget> createState() => _CantinaWidgetState();
}

class _CantinaWidgetState extends State<CantinaWidget> {
  late CantinaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CantinaModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<SalesInfoWeekRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SalesInfoWeekRecord> cantinaSalesInfoWeekRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final cantinaSalesInfoWeekRecord =
            cantinaSalesInfoWeekRecordList.isNotEmpty
                ? cantinaSalesInfoWeekRecordList.first
                : null;
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(
                          'assets/images/Bife-de-frango-grelhado-com-arroz-salada-web.jpg',
                          width: double.infinity,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Align(
                                    alignment:
                                        const AlignmentDirectional(-0.17, -0.23),
                                    child: Text(
                                      'Meat option: Chicken steak with spaghetti\nFish option: Baked sardines with boiled potatoes \nand pepper salad\nVegetarian option: Seitan chop suey',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Readex Pro',
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return FFButtonWidget(
                                            onPressed: () async {
                                                  ...
                                                  .set(createMyOrdersRecordData(
                                                    restaurantName:
                                                        buttonAvailableBagsRecord
                                                            .name,
                                                    image:
                                                        'https://auchaneeu.auchan.pt/content/uploads/2015/10/Bife-de-frango-grelhado-com-arroz-salada-web.jpg',
                                              ...
                                              await cantinaSalesInfoWeekRecord!
                                                  .reference
                                                  .delete();
                                              while (buttonAvailableBagsRecord
                                                      .quantity ==
                                                  0) {
                                                await buttonAvailableBagsRecord
                                                    .reference

...
import 'grill_model.dart';
export 'grill_model.dart';

class GrillWidget extends StatefulWidget {
  const GrillWidget({super.key});

  @override
  State<GrillWidget> createState() => _GrillWidgetState();
}

class _GrillWidgetState extends State<GrillWidget> {
  late GrillModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GrillModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<SalesInfoWeekRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SalesInfoWeekRecord> grillSalesInfoWeekRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final grillSalesInfoWeekRecord = grillSalesInfoWeekRecordList.isNotEmpty
            ? grillSalesInfoWeekRecordList.first
            : null;
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(
                          'assets/images/lagosta-4952603_1920.jpg',
                          width: double.infinity,
                              ...
                              child: Row(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Text(
                                      'Meat option: Little french girl\nFish option: Maine lobster with lemon soaked \npotatoes and salad \nVegetarian option: Seitan chop suey',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Readex Pro',
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              await grillSalesInfoWeekRecord!
                                                  .reference
                                                  .delete();
                                            },
                                            text: 'Buy bag',

  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserRecord> editProfileUserUserRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editProfileUserUserRecord =
            editProfileUserUserRecordList.isNotEmpty
                ? editProfileUserUserRecordList.first
                : null;
                                        ...
                                        Flexible(
                                          child: Align(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                await editProfileUserUserRecord!
                                                    .reference
                                                    .update(

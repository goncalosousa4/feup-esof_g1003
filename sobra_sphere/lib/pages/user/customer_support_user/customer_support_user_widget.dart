...
import 'customer_support_user_model.dart';
export 'customer_support_user_model.dart';

class CustomerSupportUserWidget extends StatefulWidget {
  const CustomerSupportUserWidget({super.key});

  @override
  State<CustomerSupportUserWidget> createState() =>
      _CustomerSupportUserWidgetState();
}

class _CustomerSupportUserWidgetState extends State<CustomerSupportUserWidget>
    with TickerProviderStateMixin {
  late CustomerSupportUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomerSupportUserModel());
    ...
    return StreamBuilder<List<CostumerServiceRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CostumerServiceRecord>
            customerSupportUserCostumerServiceRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final customerSupportUserCostumerServiceRecord =
            customerSupportUserCostumerServiceRecordList.isNotEmpty
                ? customerSupportUserCostumerServiceRecordList.first
                : null;
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                      ...
                                                      text:
                                                          customerSupportUserCostumerServiceRecord
                                                              ?.name,
                                                    ),
                                                    focusNode: _model
                                                        .textFieldFocusNode1,
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        await CostumerServiceRecord.collection
                                            .doc()
                                            .set(
